...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "rust.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            return fetch( "rust.wasm", {credentials: "same-origin"} )
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_c50b4a6de9b77af29cda5432f603a6923190bc6b": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){var a = 0 ; if (! ! ($1). attributes)a = ($2). attributes.length ; return a ;})());
            },
            "__extjs_ab0172912f8fa2965c74194116b45b78b52b67a5": function($0, $1, $2, $3) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);Module.STDWEB_PRIVATE.from_js($0, (function(){var a ; if (! ! ($1). attributes)a = ($2). attributes [($3)]; return a ;})());
            },
            ...
            "__extjs_7f455164e1ea4b48801a873e1092a18e7d4feeaa": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). name})());
            },
            "__extjs_86c685e0901666c70fef8443f2cdbf65c618397c": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return eval (($1))})());
            },
            "__extjs_c5e04f7c7eb5681c3ab83246790a9076ebdfe7e4": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return JSON.parse (($1)). red})());
            },
            ...
            "__extjs_c324d9292a5a2f33cd26652722c3cc361e335e97": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). createDocumentFragment ();})());
            },
            ...
            "__extjs_9a2b6ec93337b4fadca4a407855c3987149ec418": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). hasChildNodes ();})());
            },
