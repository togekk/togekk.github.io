...
if [ -f "D:\Program Files\Epic Games\UE_4.18\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "D:\Program Files\Epic Games\UE_4.18\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
